...
var author$project$Mechanic$Overview = {$: 'Overview'};
var author$project$Mechanic$Car = F5(
	function (regNr, car, workType, status, mechanic) {
		return {car: car, mechanic: mechanic, regNr: regNr, status: status, workType: workType};
	});
...
var author$project$Mechanic$validate = A2(
	etaque$elm_form$Form$Validate$andMap,
	A2(etaque$elm_form$Form$Validate$field, 'mechanic', etaque$elm_form$Form$Validate$string),
	A2(
		etaque$elm_form$Form$Validate$andMap,
		A2(etaque$elm_form$Form$Validate$field, 'status', etaque$elm_form$Form$Validate$string),
		A2(
			etaque$elm_form$Form$Validate$andMap,
			A2(etaque$elm_form$Form$Validate$field, 'workType', etaque$elm_form$Form$Validate$string),
			A2(
				etaque$elm_form$Form$Validate$andMap,
				A2(etaque$elm_form$Form$Validate$field, 'car', etaque$elm_form$Form$Validate$string),
				A2(
					etaque$elm_form$Form$Validate$andMap,
					A2(etaque$elm_form$Form$Validate$field, 'regNr', etaque$elm_form$Form$Validate$string),
					etaque$elm_form$Form$Validate$succeed(author$project$Mechanic$Car))))));
...
var author$project$Mechanic$init = function (_n0) {
	var model = {
		carForm: A2(etaque$elm_form$Form$initial, _List_Nil, author$project$Mechanic$validate),
		cars: _List_fromArray(
			[
				{car: 'Hyundai I40', mechanic: 'Ole', regNr: 'ZT47121', status: 'Venter på mekaniker', workType: 'EU-kontroll'},
				{car: 'Skoda Octavia', mechanic: 'Ole', regNr: 'ZT52590', status: 'Arbeid startet 08:14', workType: 'Dekkskifte'}
			]),
		mechanic: 'Ole',
		page: author$project$Mechanic$Overview,
...
var author$project$Mechanic$subscriptions = function (model) {
...
var author$project$Mechanic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SetTableState':
				var newState = msg.a;
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							carForm: A3(etaque$elm_form$Form$update, author$project$Mechanic$validate, formMsg, model.carForm)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Mechanic$SetTableState = function (a) {
...
var author$project$Mechanic$tableConfig = billstclair$elm_sortable_table$Table$customConfig(
	{
		...
		customizations: _Utils_update(
			billstclair$elm_sortable_table$Table$defaultCustomizations,
			{
				tableAttrs: _List_fromArray(
					[
						elm$html$Html$Attributes$class('overview mechanic')
					])
			}),
		toId: function ($) {
			return $.regNr;
		},
		toMsg: author$project$Mechanic$SetTableState
	});
...
var author$project$Mechanic$carsView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Dine biler: ' + model.mechanic)
					])),
				A3(billstclair$elm_sortable_table$Table$view, author$project$Mechanic$tableConfig, model.tableState, model.cars)
			]));
};
var author$project$Mechanic$ChangePage = function (a) {
	return {$: 'ChangePage', a: a};
};
var author$project$Mechanic$CreateCar = {$: 'CreateCar'};
...
var author$project$Mechanic$createCarButton = function (model) {
	return A2(
		elm$html$Html$button,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('create-car'),
				elm$html$Html$Events$onClick(
				author$project$Mechanic$ChangePage(author$project$Mechanic$CreateCar))
			]),
		_List_fromArray(
			[
				elm$html$Html$text('Ny bil')
			]));
};
var author$project$Mechanic$FormMsg = function (a) {
	return {$: 'FormMsg', a: a};
};
...
var author$project$Mechanic$formView = function (form) {
	var workType = A2(etaque$elm_form$Form$getFieldAsString, 'workType', form);
	var status = A2(etaque$elm_form$Form$getFieldAsString, 'status', form);
	var regNr = A2(etaque$elm_form$Form$getFieldAsString, 'regNr', form);
	var mechanic = A2(etaque$elm_form$Form$getFieldAsString, 'mechanic', form);
	...
	var car = A2(etaque$elm_form$Form$getFieldAsString, 'car', form);
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Reg.nr')
					])),
				A2(etaque$elm_form$Form$Input$textInput, regNr, _List_Nil),
				errorFor(regNr),
				A2(
				elm$html$Html$label,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Bilmerke')
					])),
				A2(etaque$elm_form$Form$Input$textInput, car, _List_Nil),
				errorFor(car),
				A2(
				elm$html$Html$label,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Hva gjøres')
					])),
				A2(etaque$elm_form$Form$Input$textInput, workType, _List_Nil),
				errorFor(workType),
				A2(
				elm$html$Html$label,
				_List_Nil,
				...
				A2(etaque$elm_form$Form$Input$textInput, status, _List_Nil),
				errorFor(status),
				A2(
				elm$html$Html$label,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Mekaniker')
					])),
				A2(etaque$elm_form$Form$Input$textInput, mechanic, _List_Nil),
				errorFor(mechanic),
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Lagre')
					]))
			]));
};
var elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var elm$html$Html$map = elm$virtual_dom$VirtualDom$map;
var author$project$Mechanic$createCarView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
				elm$html$Html$map,
				author$project$Mechanic$FormMsg,
				author$project$Mechanic$formView(model.carForm))
			]));
};
...
var author$project$Mechanic$headerView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onClick(
						author$project$Mechanic$ChangePage(author$project$Mechanic$Overview))
					]),
				_List_Nil)
			]));
};
var author$project$Mechanic$view = function (model) {
	var page = function () {
		var _n0 = model.page;
		if (_n0.$ === 'Overview') {
			return _List_fromArray(
				[
					author$project$Mechanic$headerView(model),
					author$project$Mechanic$carsView(model),
					author$project$Mechanic$createCarButton(model)
				]);
		} else {
			return _List_fromArray(
				[
					author$project$Mechanic$headerView(model),
					author$project$Mechanic$createCarView(model)
				]);
		}
	}();
	return A2(elm$html$Html$div, _List_Nil, page);
};
...
var author$project$Mechanic$main = elm$browser$Browser$element(
	{init: author$project$Mechanic$init, subscriptions: author$project$Mechanic$subscriptions, update: author$project$Mechanic$update, view: author$project$Mechanic$view});
_Platform_export({'Mechanic':{'init':author$project$Mechanic$main(
